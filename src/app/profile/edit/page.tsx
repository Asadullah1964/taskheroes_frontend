        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="space-y-6 lg:col-span-2">
            <form
              ...
              className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8 dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-black/20"
            >
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <button
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center justify-center rounded-2xl bg-neutral-900 px-5 py-3 text-sm font-medium text-white transition hover:bg-neutral-800 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
                >
    ...
    <main className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6">
          ...
          <div className="mt-4 h-9 w-48 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
          <div className="mt-3 h-4 w-80 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
        </div>

        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8 dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-black/20">
              ...
              <div className="mt-8 h-28 w-28 animate-pulse rounded-3xl bg-neutral-200 dark:bg-neutral-800" />

              <div className="mt-8 space-y-6">
                {[1, 2, 3].map((item) => (
                  <div key={item}>
                    <div className="mb-2 h-4 w-28 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
                    <div className="mb-3 h-4 w-64 animate-pulse rounded bg-neutral-100 dark:bg-neutral-800" />
              ...
              <div className="mt-8 flex gap-3">
                ...
                <div className="h-12 w-24 animate-pulse rounded-2xl bg-neutral-200 dark:bg-neutral-800" />
              </div>
            </div>
          </div>
            ...
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-black/20">
              ...
              <div className="mt-4 space-y-3">
                {[1, 2, 3, 4].map((item) => (
                  <div
                    key={item}
                    className="h-12 animate-pulse rounded-2xl bg-neutral-100 dark:bg-neutral-800"
                  />
                ))}
              </div>
            </div>

            <div className="rounded-3xl bg-neutral-900 p-6 shadow-sm dark:bg-white">
              <div className="h-6 w-28 animate-pulse rounded bg-white/20 dark:bg-neutral-200" />
              <div className="mt-3 h-4 w-full animate-pulse rounded bg-white/10 dark:bg-neutral-200" />
              <div className="mt-2 h-4 w-5/6 animate-pulse rounded bg-white/10 dark:bg-neutral-200" />
            </div>
          </div>
        </div>
      </div>
