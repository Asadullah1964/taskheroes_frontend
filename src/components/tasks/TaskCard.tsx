...
export default function TaskCard({ task }: Props) {
  const statusStyles: Record<string, string> = {
    Open: "border border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900/60 dark:bg-emerald-950/40 dark:text-emerald-300",
    Assigned:
  ...
  return (
    <div className="group flex h-full flex-col rounded-3xl border border-neutral-200 bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-black/20">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h2 className="line-clamp-2 text-lg font-semibold tracking-tight text-neutral-900 dark:text-neutral-100">
            {task.title}
          </h2>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl bg-neutral-50 px-4 py-3 dark:bg-neutral-800/70">
          ...
          <p className="mt-2 line-clamp-1 text-sm font-semibold text-neutral-900 dark:text-neutral-100">
            {task.location}
          </p>
        </div>
      </div>

      <div className="mt-3 rounded-2xl bg-neutral-50 px-4 py-3 dark:bg-neutral-800/70">
        <div className="flex items-center gap-2 text-neutral-500 dark:text-neutral-400">
      ...
      <div className="mt-5 flex items-center justify-between border-t border-neutral-200 pt-4 dark:border-neutral-800">
        ...
        <Link
          href={`/tasks/${task._id}`}
          className="inline-flex items-center gap-2 rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
        >
          View task
